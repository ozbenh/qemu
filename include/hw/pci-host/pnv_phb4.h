...
struct PnvPHB4 {
    ...
    /* Geometry of the PHB. There are two types, small and big PHBs, a number
     * of resources (number of PEs, windows etc...) are doubled for a big PHB
     */
    bool big_phb;

    /* Memory regions for MMIO space */
    MemoryRegion mr_mmio[PNV_PHB4_MAX_MMIO_WINDOWS];
    bool mmio_mapped[PNV_PHB4_MAX_MMIO_WINDOWS];
...
#define PNV_PHB4_PEC(obj) OBJECT_CHECK(PnvPhb4PecState, (obj), TYPE_PNV_PHB4_PEC)

#define TYPE_PNV_PHB4_PEC_STACK "pnv-phb4-pec-stack"
#define PNV_PHB4_PEC_STACK(obj) OBJECT_CHECK(PnvPhb4PecStack, (obj), TYPE_PNV_PHB4_PEC_STACK)
