...
/* WARNING: This field doesn't actually exist in the final version of the
 * architecture and is unused by hardware. However, qemu uses it as an
 * indication of a radix guest in the pseudo-PATB entry that it maintains
 * for SPAPR guests and in the migration stream, so we need to keep it around
 */
...
static inline void ppc64_v3_new_to_old_hpte(target_ulong *pte0, target_ulong *pte1)
{
    /* Insert B into pte0 */
